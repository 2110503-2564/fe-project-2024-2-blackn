        ...
        <div className="flex gap-5 max-md:flex-col h-lvh">
          <div className="w-[39%] max-md:ml-0 max-md:w-full">
            ...
            />
              ...
              <div className={`flex gap-10 /*ml-10*/ mt-6 w-[70%] whitespace-nowrap mb-[16%] max-md:mt-10`}>                
          ...
          {error === "Failed to load bookings" ? (
            ...
            <div className="flex justify-end w-full max-md:ml-0 max-md:w-full">
              <div className={`flex flex-col mt-2 px-12 pt-10 w-[90%] h-[94%] overflow-auto bg-gradient-to-r from-green-100 to-sky-100 rounded-3xl /*pb-[464px]*/ max-md:px-5 max-md:pb-24 max-md:mt-10 max-md:max-w-full shadow-lg transform /*hover:scale-[1.01]*/ transition-all duration-300`}>
