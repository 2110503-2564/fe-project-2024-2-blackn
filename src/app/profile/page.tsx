...
export default function Profile() {
  ...
  return (
    <div className={`flex overflow-hidden flex-col justify-center px-6 py-4 bg-gradient-to-b from-green-100 to-white min-h-screen max-md:px-5`}>
      <div className={`px-28  bg-white rounded-3xl h-[calc(100vh-32px)] max-md:px-5 max-md:max-w-full shadow-xl transform /*hover:scale-[1.01]*/ transition-all duration-300`}>
        <div className="flex gap-5 max-md:flex-col">
          <div className="w-[39%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col items-start mt-20 w-full text-3xl text-black max-md:mt-10">
              ...
              <div className="mt-12 max-md:mt-10">Name</div>
              <div className={`flex gap-9 items-start mt-6 w-[70%] /*ml-11*/ whitespace-nowrap max-md:ml-2.5`}>
              <input
            ...
            />
              ...
              <div className={`flex gap-10 mt-6 /*ml-11*/ w-[70%] whitespace-nowrap max-md:mt-10 max-md:ml-2.5`}>
                  <input
                  className="w-full text-xl rounded-3xl bg-zinc-100 h-[62px] px-6 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  name="email"
                  type="text"
              ...
              <div className={`flex gap-10 /*ml-10*/ mt-6 w-[70%] whitespace-nowrap mb-14 max-md:mt-10`}>                
          ...
          {error === "Failed to load bookings" ? (
            ...
            <div className="flex justify-end w-full max-md:ml-0 max-md:w-full">
              <div className={`flex flex-col mt-2 px-12 pt-10 w-[90%] max-h-full overflow-auto bg-gradient-to-r from-green-100 to-sky-100 rounded-3xl /*pb-[464px]*/ max-md:px-5 max-md:pb-24 max-md:mt-10 max-md:max-w-full shadow-lg transform /*hover:scale-[1.01]*/ transition-all duration-300`}>
