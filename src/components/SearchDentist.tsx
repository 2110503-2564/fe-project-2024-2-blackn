    ...
    <div className="flex flex-row justify-between mb-10">
      <div className="flex flex-col justify-start items-center">
        <div>
          <button
            ...
            className="inline-flex items-center text-center px-2 py-2 m-2 bg-sky-200 rounded-3xl cursor-pointer h-auto w-auto max-sm:w-full hover:bg-sky-300 focus:outline-none focus:ring-2 focus:ring-sky-400 focus:ring-offset-2 transition-colors"
            type="button"
      ...
      <div className="flex flex-col justify-center items-center">
        <div className="flex flex-row justify-end">
          ...
          <button
            className="inline-flex items-center text-center px-4 py-2 m-2 bg-sky-200 rounded-3xl cursor-pointer h-15 w-30 hover:bg-sky-300 hover:ring-2 hover:ring-sky-400 hover:ring-offset-2 transition-colors"
            type="button"
            onClick={() => {
              console.log("Reset");
              setSelected([]);
        ...
        <div>
          <div className="w-auto h-auto p-2 m-2 bg-sky-200 rounded-3xl flex flex-row justify-center items-center">
            <button
